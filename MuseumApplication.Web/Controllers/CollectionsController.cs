...
namespace MuseumApplication.Web.Controllers
{
    public class CollectionsController : Controller
    {
        ...
        {
            return View(_collectionService.GetAll());
        }
        ...
        public IActionResult Details(Guid? id)
        {
            ...
            var collection = _collectionService.GetById(id.Value);
            if (collection == null)
            {
                return NotFound();
            }
        ...
        {
            _collectionService.DeleteById(id);
            return RedirectToAction(nameof(Index));
        }

        private bool CollectionExists(Guid id)
        {
            return _collectionService.GetById(id) != null;
        }
    }
}
